			...
			<view class="info">
				...
				<!-- 	<view class="blue-tip">
					...
					<view class="info-item">
						...
						<view class="right">商家可扫码退款或查询交易</view>
					</view>
					<view class="info-item lineCodeItem" >
						<image class="lineCode" src="/static/zfb/lineCode.png" mode="widthFix" />
						<view class="lineCodeText" @click="exitInfo">{{info.lineCodeText || '0461 ****** 点击查看订单号'}}</view>
					</view>
				</view>
			</view>
			<view class="Bill">
