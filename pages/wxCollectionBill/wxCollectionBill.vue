<template>
  <view class="container">
    ...
    <view class="content">
      ...
      <view class="amount-section" @click="openEditModal" style="margin-bottom: 20rpx;">
	  ...
	  <view class="detail-link" style="padding-bottom: 40rpx;" @click="goToDetail">
	    <text class="link-text">零钱余额</text>
	  </view>
