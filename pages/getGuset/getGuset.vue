		...
		<view class="main-warp">
			...
			<view class="center-warp">
				...
				<view class="usage-scenario">
					...
					<view class="scenario-container">
						...
						<view class="website-card">
							...
							<view class="step">
								<image class="icon" src="/static/one-icon.png"></image>
								<text>各场景中点击链接</text>
							</view>
						</view>
						<!-- 微信用户 -->
						<view class="wechat-card">
							<view class="avatar-container">
								<image src="/static/avatar-me.png" class="avatar" />
								<view class="user-info">
									<view class="name">刘薇</view>
									<view class="description">@一湾智能生活</view>
								</view>
							</view>
							...
							<view class="step">
								<image class="icon" src="/static/yes-icon.png"></image>
								<text>微信内添加好友</text>
							</view>
						</view>
					</view>
				...
				<view class="usage-scenario">
					...
					<view class="client-main">
						<view class="client-warp">
							<view class="num-text">{{NewAddToday}}</view>
							<view>今日新增客户</view>
						</view>
						<view class="client-warp">
							<view class="num-text">{{CumulativeNew}}</view>
							<view>累计新增客户</view>
						</view>
						<view class="client-warp">
							<view class="num-text">{{Remainder}}</view>
				...
				<view class="usage-scenario">
					...
					<view class="all-warp">查看全部 5 > </view>
				</view>
				<!-- 更多功能 -->
				<view class="usage-scenario">
					...
					<view class="acquisition-methods more-warp">
						...
						<view class="method-item">
							<view class="item-right">
								<image class="left-icon" src="/static/share-icon.png"></image>
								<text>自动跳过成员异常账号</text>
							</view>
							<image class="right-icon" src="/static/right-icon.png"></image>
						</view>
