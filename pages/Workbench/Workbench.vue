<template>
	<view class="container">
		...
		<view class="head" :style="{ paddingTop: statusBarHeight + 'px' }">
			<image src="/static/conelse/head.png" mode="widthFix"></image>
		</view>
		<view class="content"  >
			<!-- 工作台内容 -->
		...
		<EditableFormPopup ref="workbenchPopup" :value="workbenchData" :fieldLabels="workbenchLabels" @submit="onWorkbenchSubmit" />
	</view>
</template>
