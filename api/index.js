...
export const getPayMember = (userId) => request({ url: '/user/pay/member?userId='+userId, method: 'GET' })
export const logout = (userId) => request({ url: '/user/logout/'+userId, method: 'POST' })
 
export const activateMember = (userId) => request({ url: '/user/activate-member/'+userId, method: 'POST' })
