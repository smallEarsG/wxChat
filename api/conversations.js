import { request,Filerequest,uploadImageByPath ,requestJSON} from '@/utils/request.js'

export const createConversation = (data) => 
  requestJSON({ url: '/conversations', method: 'POST', data })
...
export const updateConversation = (conversationId, data) => 
  requestJSON({ url: `/conversations/${conversationId}`, method: 'PUT', data })
   ...
   * @returns {Promise}
   */
  export const uploadImage = (file, conversationId) => {
		console.log("=====开始上传文件====");
    return uploadImageByPath(file, conversationId)
  };